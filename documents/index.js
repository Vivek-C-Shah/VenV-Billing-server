...
<section class="address">
      ...
      <div>
          ...
          <h4 style="font-size: 9px; line-height: 5px">${'Dev Mathukiya'}</h4>
          <p style="font-size: 9px; line-height: 5px">${'Dev gmail'}</p>
          <p style="font-size: 9px; line-height: 5px">${'Dev mobile number'}</p>
          <p style="font-size: 9px; line-height: 5px">${'Dev Company Contact Address'}</p>
      </div>
